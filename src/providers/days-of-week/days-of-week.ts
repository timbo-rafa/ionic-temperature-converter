...
@Injectable()
export class DaysOfWeekProvider {

  constructor(public http: HttpClient) {
    console.log('Hello DaysOfWeekProvider Provider');
  }
   ...
   define = function(language, sun, mon, tue, wed, thu, fri, sat) {
      this.languages[language] = [ mon, tue, wed, thu, fri, sat ];
   };
   ...
   factory() {
      ...
      factory = {
         ...
         days: function(language) {
            ...
            if (!(language in this.languages)) throw new Error('Unknown language specified');
